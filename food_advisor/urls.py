...
urlpatterns = [
    ...
    path('restaurant/<int:restaurant_id>/reviews/<slug:review_id>', views.review_reply, name='review_reply'),
    path('restaurant/<int:restaurant_id>/manage/', views.manage_restaurant, name='manage_restaurant'),
    path('signout/', views.user_logout, name='signout'),
    path('ajax/add_dish/<int:restaurant_id>/', views.add_dish_ajax, name='add_dish_ajax'),
